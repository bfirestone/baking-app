...
public class CookBookRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    private Context mContext;
    private Recipe recipe;

    public CookBookRemoteViewsFactory(Context context) {
    ...
    public void onDataSetChanged() {
        recipe = RecipeUtils.loadRecipe(mContext);
    }
    ...
    public RemoteViews getViewAt(int position) {
        ...
        row.setTextViewText(R.id.ingredient_item_text, recipe.getIngredients().get(position).getName());
